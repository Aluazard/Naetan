...
NCharacter = {
	...
	AGE_OF_ADULTHOOD_MALE = 11,						-- Male can rule at this age.
	AGE_OF_ADULTHOOD_FEMALE = 11,					-- Female can rule at this age.
	AGE_OF_MARRIAGE_MALE = 5,						-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 5,					-- Female allowed to marry at this age.
	AGE_ADOLESCENT = 8,							-- Children are considered to be adolescent from this age
