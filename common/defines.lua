...
NCharacter = {
	...
	NEED_GUARDIAN_AT_AGE = 5, 						-- The age at which children should be appointed a mentor/guardian
	...
	PORTRAIT_ADULT_MALE_AGE_THRESHOLD = 11,			-- Male child to adult age portrait switch
	PORTRAIT_ADULT_FEMALE_AGE_THRESHOLD = 11,		-- Female child to adult age portrait switch
	...
	AGE_OF_MARRIAGE_MALE = 5,						-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 5,					-- Female allowed to marry at this age.
	AGE_ADOLESCENT = 9,							-- Children are considered to be adolescent from this age
	AGE_YOUNG = 18,									-- Non-child characters below this age have the 'teen' static modifier applied
	AGE_ADULT = 40,									-- Non-child characters below this age have the 'young' static modifier applied
	...
	MAX_CHILD_BIRTH_AGE = 55,						-- Female menopause age.
	...
	CHILDHOOD_FOCUS_ALERT_AGE = 4,					-- The childhood focus alert is shown for children this old
	AGE_CHILDHOOD_PULSE = 3,						-- The childhood pulse events start from this age
	CHILDHOOD_AUTO_EDUCATION_FOCUS_AGE = 7,		-- Children automatically get education focus at this age.
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 10000,
	...
	IDEAL_YEAR_LEVEL_0 = 14000, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 16400,
